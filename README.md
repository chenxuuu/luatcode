# 合宙 Luat 与 移远 QuecPython 代码自动补全插件[![Build status](https://ci.appveyor.com/api/projects/status/6jmmlfyg4iroik9w?svg=true)](https://ci.appveyor.com/project/chenxuuu/luatcode)
